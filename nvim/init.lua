...
require('lazy').setup({
  ...
  -- Harpoon, blazingly fast way to navigate files
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-w>", require("harpoon.ui").toggle_quick_menu)
...
-- Diagnostic keymaps
vim.keymap.set('n', '<C-d>', vim.diagnostic.goto_prev, { desc = 'Go to previous diagnostic message' })
vim.keymap.set('n', '<C-S-d>', vim.diagnostic.goto_next, { desc = 'Go to next diagnostic message' })
vim.keymap.set('n', '<leader>r', vim.diagnostic.open_float, { desc = 'Open floating diagnostic message' })
vim.keymap.set('n', '<C-e>', vim.diagnostic.setloclist, { desc = 'Open diagnostics list' })
--
-- [[ Configure LSP ]]
